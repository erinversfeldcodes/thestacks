...
- [x] Gates green in the lint suite (orphan 0; check-css 0/0/0; check-css-values at budget); elm 1743/0; Wave 9 is CSS/scripts/docs-only so the elixir/rust/dbt/security/squawk gates are unaffected (green in the Wave 8 code-gate CI, 3540/0 etc.). Full deploy+E2E re-runs at finalize-pr.
