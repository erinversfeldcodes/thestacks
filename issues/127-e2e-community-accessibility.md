...
|-----------|------------------------------|-------------------|---------|------------|
| US-18.1.1 — Browse the Looking for a Home Shelf | ⬜ to verify | ⬜ to verify | ⬜ | — |
| US-19.1.1 — ARIA Labels for Visual Elements | ⬜ to verify | ⬜ to verify | ⬜ | — |
| US-19.1.2 — Keyboard Navigation | ⬜ to verify | ⬜ to verify | ⬜ | — |
| US-19.2.1 — List View Toggle | ⬜ to verify | ⬜ to verify | ⬜ | — |
