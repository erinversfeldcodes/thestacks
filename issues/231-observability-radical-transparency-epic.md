...
| **#232** | infra | **Live metrics stack.** Persistent Prometheus scrape of `/internal/metrics` + a Grafana instance (Fly-managed or Grafana Cloud) + datasource + PromEx upload config/secrets; smoke-test the panels resolve. | #230 |
