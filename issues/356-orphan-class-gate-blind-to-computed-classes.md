...
## Definition of Done
- [ ] Extractor handles computed class forms — evidence: diff
- [ ] Before/after orphan counts reported and each new orphan triaged — evidence: the numbers + dispositions
- [ ] Counterfactual red — evidence: both transcripts
- [ ] Shelf buttons styled in-theme, design confirmed with the owner — evidence: screenshot
- [ ] `check-css.sh` clean — evidence: output
