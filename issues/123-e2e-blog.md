...
|-----------|------------------------------|-------------------|---------|------------|
| US-12.1.1 — Write a Blog Post | ⬜ to verify | ⬜ to verify | ⬜ | — |
| US-12.1.2 — LLM Book Associations on a Post | ⬜ to verify | ⬜ to verify | ⬜ | — |
| US-12.1.3 — Browse Another User's Blog | ⬜ to verify | ⬜ to verify | ⬜ | — |
