defmodule Stacks.FeatureFlags do
  @moduledoc """
      Central read-side for The Stacks' runtime feature flags.
  ...
  @doc """
      ...
      is integrated. The test env sets this to `true` so the full
  ...
  @doc """
      Whether registration is gated behind an invitation (, closed beta).
