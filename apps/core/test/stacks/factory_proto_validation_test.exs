  ...
  @factories %{
    user:
      {Stacks.Accounts.User,
       ~w(age_verified_at age_verification_provider city website_url consent_analytics_at consent_writing_assistant_at email_confirmation_token password_reset_token password_reset_sent_at onboarding_completed failed_login_first_at locked_until pending_email pending_email_token pending_email_sent_at pending_email_revert_token)a},
