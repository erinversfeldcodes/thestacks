defmodule Stacks.AI.VisionFixtures do
  ...
  Before Issue #331 every test file that needed a non-default vision answer
  ...
  the Issue #167 threshold gate treats absent and present-nil differently. Pass
  ...
  one the Issue #167 threshold gate reads. `:confidence` keeps its
