defmodule Core.Repo.Migrations.CreateSchemas do
  ...
  def up do
    ...
    execute("DO $$ BEGIN EXECUTE 'ALTER DATABASE ' || current_database() || ' SET search_path TO op, public'; END $$")
  end

  def down do
    execute("DO $$ BEGIN EXECUTE 'ALTER DATABASE ' || current_database() || ' SET search_path TO public'; END $$")
