...
### Happy Path
1. Business owner sees their business listed on the Third Spaces page.
2. They click the discreet "Is this your business?" link on the space's detail card (`frontend/src/Page/ThirdSpaces.elm:179-183`, linking to `Route.ListingRemoval`). Discreet is the specification, not a style preference: this is a listing the business never asked for, so the way out should be findable without being an apology across the card.
