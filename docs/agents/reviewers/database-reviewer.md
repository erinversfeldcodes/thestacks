...
### 2. PostgreSQL / Ecto / dbt Community Standards (mechanical — specialist self-checks)
- **Migrations**:
...
### 4. Performance (mixed — specialist checks index presence; reviewer assesses performance trade-offs)
